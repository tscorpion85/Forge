...
const script=html.split('<script>')[1].split('</script>')[0].replace('})();','globalThis.orbit={advance,preset,suns,planets,planet,sun};})();');
...
console.log('Orbit stability, presets and collisions passed');
